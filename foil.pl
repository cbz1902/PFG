...
% Modificaciones de Miguel A. Guti�rrez Naranjo
% 2 de Marzo de 2008
...
% Nuevo par�metro: verbosity
% - verbosity(0) Devuelve s�lo la ganancia de informaci�n
% - verbosity(1) Devuelve el n�mero de ejemplos positivos y negativos
%   cubiertos
% - verbosity(2) Devuelve tambi�n la lista de ejemplos positivos y
%   negativos cubiertos.
...
foil(Goal) :-
	foil(Goal,Clauses),
	nl, write('Definici�n encontrada:'), nl,
...
foil_loop(Pos, Goal, Neg, Clauses0, Clauses) :-
	...
	; nl, write('Ejemplos positivos no cubiertos:'), nl,
	  write(Pos), nl,
	  nl, write('A�adiendo una regla ...'), nl, nl,
...
informa(1,T,_,Clause,_,P,_,N):-
	...
	nl,
	write('N�mero de ejemplos positivos: '), write(P),nl,
	write('N�mero de ejemplos negativos: '), write(N),nl,
	write('N�mero de pos. cubiertos en la cl�usula ampliada: '),
	write(T),nl.
informa(2,T,Retained,Clause,Ptuples,P,Ntuples,N):-
	...
	write('N�mero de pos. cubiertos en la cl�usula ampliada: '),
	write(T),nl,
	write('Positivos cubiertos en la cl�usula ampliada: '),
	write(Retained),nl.
...
%      He descomentado las siguientes 3 l�neas
